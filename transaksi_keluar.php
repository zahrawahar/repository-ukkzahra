...
if (isset($_POST['tambah_barang_keluar'])) {
    ...
    foreach ($namas as $i => $val) {
        ...
        // 🔍 CEK BARANG BERDASARKAN NAMA & HARGA (HARUS SUDAH ADA)
        $cek_barang = $conn->query("
        SELECT id_barang, stok, stok_baik 
        FROM barang 
        WHERE nama = '$nama' AND harga = '$harga' 
        LIMIT 1
    ");

        // ❌ JIKA BARANG TIDAK ADA → SKIP
        ...
        $conn->query("
        UPDATE barang 
        SET stok = '$stok_baru', stok_baik = '$stok_baik_baru'
        WHERE id_barang = '$id_barang_final'
    ");

        // 📝 CATAT TRANSAKSI BARANG KELUAR
        $sql_transaksi = "
        INSERT INTO transaksi (id_user, id_barang, stok, tanggal_transaksi, status) 
        VALUES ('$id_user', '$id_barang_final', '$stok', '$tanggal', 'keluar')
    ";
    ...
    if ($count > 0) {
        echo "<script>alert('Berhasil memproses $count data barang keluar!'); window.location='transaksi_keluar.php';</script>";
    }
}
    ...
    <body>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row mb-4">
                    <div class="col-12">
                        <h2 class="fw-bold">Transaksi Barang Keluar</h2>
                    </div>
                </div>

                <div class="card">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                        <h5 class="m-0 fw-bold text-primary"><i class="fas fa-list me-2"></i>Daftar Item Keluar</h5>
                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="mt-4 border-top pt-3 text-end">
                                ...
                                <button type="submit" name="tambah_barang_keluar" class="btn btn-success px-5 shadow-sm">
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content shadow" id="notaArea" style="border-radius: 15px;">
                    ...
                    <div class="modal-header bg-dark text-white text-center d-block">
                        ...
                        <small class="text-light">Nota Barang Keluar</small>
